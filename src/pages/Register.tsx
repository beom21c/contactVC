...
export default function Register() {
    ...
    function changeValue(type: string, value: any) {
        setInfo(v => {
            let property = {}
            // @ts-ignore
            property[type] = value;
        ...
        <div className={'register_container'}>
            <div>
                ...
                <div style={{fontSize: 20, cursor: 'pointer'}}>
                    ...
                    }} onClick={() => changeValue('type', 'startUp')}>스타트업으로 등업
                    </div>
                    <div style={{
                        height: 60,
                    ...
                    }} onClick={() => changeValue('type', 'invset')}>투자사로 등업
                    </div>
                </div>
                <div style={{paddingTop: 30}}>회사명 <span>*</span></div>
                <input type="text" value={info.company} onChange={(e) => changeValue('company', e.target.value)}
                       placeholder={'한글 회사명을 입력하세요'}/>

                <div>성함<span>*</span></div>
                <input type="text" value={info.name} onChange={(e) => changeValue('name', e.target.value)}
                       placeholder={'성함을 입력하세요'}/>

                <div>아이디<span>*</span></div>
                <div className="input-wrapper">
                    <input type="text" value={info.id} onChange={(e) => changeValue('id', e.target.value)}
                           placeholder={'아이디를 입력하세요'}/>
                    <div className="suffix">중복확인</div>
                </div>

                <div>직책<span>*</span></div>
                <input type="text" value={info.position} onChange={(e) => changeValue('position', e.target.value)}
                       placeholder={'직책을 입력하세요'}/>

                <div>메일주소<span>*</span></div>
                <div className="input-wrapper">
                    <input type="text" value={info.email} onChange={(e) => changeValue('email', e.target.value)}
                ...
                <div className="input-wrapper">
                    <input type="text" value={info.phone} onChange={(e) => changeValue('phone', e.target.value)}
                ...
                <input type="text" value={info.pw} onChange={(e) => changeValue('pw', e.target.value)}
                       placeholder={'비밀번호를 8자리 입력하세요'}/>

                <div>비밀번호 재입력<span>*</span></div>
                <input type="text" value={info.confirmPw} onChange={(e) => changeValue('confirmPw', e.target.value)}
                ...
                <div className={'terms_container'} style={{marginTop: 20, padding: 0}}>
                    ...
                    <div style={{fontSize: 13, color: 'lightGray', paddingLeft: 30, marginTop: -10}}>이벤트, 뉴스레터 등 서비스의
                        다양한 정보를 제공합니다.
                    </div>
                </div>
